    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Link href="/admin/dashboard/products/add" className="bg-primary hover:bg-primary hover:brightness-90 text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-colors shadow-sm">
                     ...
                     <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr key={product.id} className="border-b border-gray-50 hover:bg-primary/10/50 transition-colors group">
                                    ...
                                    <td className="py-3 px-6 text-sm">
                                        <span className="bg-secondary/10 text-secondary border border-orange-100 px-2 py-1 rounded text-xs font-mono font-bold">{product.productCode || 'N/A'}</span>
                                    </td>
                                    <td className="py-3 px-6 text-sm">
